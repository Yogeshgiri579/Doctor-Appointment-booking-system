    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
         ...
         <div className='flex flex-col gap-3 md:flex-row items-center text-white text-sm font-light' >
            ...
            <p>Simply browse through our ectensive list of trusted doctors, <br className='hidden md:block'/> 
        ...
        <img className='w-full md:absolute bottom-0 h-auto rounded-lg' src={
            assets.header_img
        } alt="" />
        </div>
    </div>
