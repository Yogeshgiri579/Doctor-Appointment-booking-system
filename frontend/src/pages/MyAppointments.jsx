       ...
       {appointments.map((item,index)=>(
        <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
           ...
           <div className='flex flex-col justify-end gap-2'>
            {!item.cancelled && item.payment && !item.isCompleted && <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border border-green-500 rounded    hover:text-gray-500 transition-all duration-300'> Paid</button>}
           ...
           {item.cancelled && !item.isCompleted && <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border border-red-500 rounded    hover:text-gray-500 transition-all duration-300'> Appointment Cancelled</button>}
